...
public class ExamplesOfJavaTimeAPI {
	...
	public static void checkLocalDateTime() {
		...
		System.out.println(
				"Following is a static map in ZoneId class which has mapping of short timezone names to their Actual timezone names");
	...
	public static void checkLocalDate() {
		...
		System.out.println(
				"now() is overridden to take ZoneID as parametere using this we can get the same date under different timezones. >> "
						+ localDate2);
	}

	/*
	 * This has the methods of abstract class {@link Clock}. Clock can be used for
	 * time which has time with {@link TimeZone}.
	 */
