...
public class InnerAnoLambdaMethRefDemo {

    private final static int SIZE = 15;
    private int[] arrayOfInts = new int[SIZE];
    
    public InnerAnoLambdaMethRefDemo() {
    ...
    public static void main(String s[]) {
        ...
        InnerAnoLambdaMethRefDemo ds = new InnerAnoLambdaMethRefDemo();
        ...
        ds.print(
            new InnerAnoLambdaMethRefDemo.DataStructureIterator() {
        ...
        ds.print(InnerAnoLambdaMethRefDemo::isEvenIndex);
        ds.print(InnerAnoLambdaMethRefDemo::isOddIndex);
    }
}
